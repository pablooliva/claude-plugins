...
Write to: `PACE/prompts/context-management/research-compacted-[YYYY-MM-DD_HH-MM-SS].md` where:
...
- Research document in progress: PACE/research/RESEARCH-[###]-[feature-name].md
