...
ls PACE/research/RESEARCH-*-[feature-name].md

# Locate specification
ls PACE/requirements/SPEC-*-[feature-name].md

# Locate prompt files
ls PACE/prompts/PROMPT-*-[feature-name]-*.md

# Check subagent logs
ls PACE/prompts/context-management/subagent-calls/
```
...
**Expected Location**: PACE/prompts/PROMPT-XXX-[feature-name]-YYYYMMDD.md
...
Create `PACE/reviews/REVIEW-XXX-[feature-name]-YYYYMMDD.md`:
