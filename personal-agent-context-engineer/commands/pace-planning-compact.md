...
Write to: `PACE/prompts/context-management/planning-compacted-[YYYY-MM-DD_HH-MM-SS].md` where:
...
- Specification in progress: PACE/requirements/SPEC-[###]-[feature-name].md:[lines]
...
- PACE/requirements/SPEC-[###]-[feature-name].md:[specific line ranges]
- PACE/research/RESEARCH-[###]-[feature-name].md:[sections needed]
...
✅ Progress file updated: `PACE/prompts/context-management/progress.md`
...
Also update `PACE/prompts/context-management/progress.md` with:
